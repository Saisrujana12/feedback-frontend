    ...
    <div className="auth-container-premium">
      <div className="auth-card-premium animate-fade-in">
        <div className="auth-header">
          ...
          <p style={{ color: 'var(--text-muted)', marginBottom: '2.5rem' }}>Create your premium account</p>
        </div>
        ...
        <div className="auth-divider" style={{ margin: '2rem 0', color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <div style={{ flex: 1, height: '1px', background: 'var(--border-glass)' }}></div>
          <span style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '1px' }}>or sign up with</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--border-glass)' }}></div>
        </div>
        ...
        <div className="auth-footer" style={{ marginTop: '2rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
          <p>
            ...
            <button
              ...
              style={{ color: 'var(--accent-primary)', fontWeight: '600', background: 'none', border: 'none', cursor: 'pointer', marginLeft: '0.5rem' }}
            >
              Sign In
            </button>
          </p>
